...
class CalculateRoman {

    static String[] in = com.company.Calc.StringIn.getInput();

    static int[] numbers = {1, 4, 5, 9, 10, 40, 50, 90, 100, 101};
    static String[] letters = {"I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CI"};

    public static int convertRomanToInt(@NotNull String roman) {
    ...
    public static void calculate(){
        ...
        if (result > 0) {
            ...
            System.out.println("Результат не может быть отрицательным числом!");
        } else {
